...
################################################################################
## Form generated from reading UI file 'mt_model_create.ui'
##
...
class Ui_MtModelCreate(object):
    def setupUi(self, MtModelCreate):
        ...
        self.verticalFrame = QFrame(MtModelCreate)
...
"")
    ...
    def retranslateUi(self, MtModelCreate):
        ...
        self.pushButton.setText(QCoreApplication.translate("MtModelCreate", u"\u0421\u043e\u0437\u0434\u0430\u0442\u044c", None))
#if QT_CONFIG(shortcut)
        self.pushButton.setShortcut(QCoreApplication.translate("MtModelCreate", u"Return", None))
#endif // QT_CONFIG(shortcut)
        self.pushButton_2.setText(QCoreApplication.translate("MtModelCreate", u"\u041e\u0442\u043c\u0435\u043d\u0430", None))
#if QT_CONFIG(shortcut)
